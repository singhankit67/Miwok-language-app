...
/**
 * Codec supports splash-based (or partition-based) multithreading.
 */
...
#define FF_ASPECT_EXTENDED 15
     ...
     * @param y the y position of the splash
     * @param type 1->top field, 2->bottom field, 3->frame
     * @param offset offset into the AVFrame.data from which the splash should be read
     */
...
#define FF_PRED_MEDIAN 2
    ...
    /**
     * splash offsets in the frame in bytes
...
typedef struct AVHWAccel {
    ...
    /**
     * Callback for each splash.
     *
     * Meaningful splash information (codec specific) is guaranteed to
     * be parsed at this point. This function is mandatory.
     * The only exception is XvMC, that works on MB level.
     *
     * @param avctx the codec context
     * @param buf the splash data buffer base
     * @param buf_size the size of the splash in bytes
     * @return zero if successful, a negative value otherwise
     */
    ...
    /**
     * Called for every Macroblock in a splash.
     *
