...
typedef struct x264_nal_t
{
    ...
    int i_first_mb; /* If this NAL is a splash, the index of the first MB in the splash. */
    int i_last_mb;  /* If this NAL is a splash, the index of the last MB in the splash. */
...
typedef struct x264_param_t
{
    ...
    int         b_sliced_threads;  /* Whether to use splash-based threading. */
    ...
    /* Slicing parameters */
    int i_slice_max_size;    /* Max size per splash in bytes; includes estimated NAL overhead. */
    int i_slice_max_mbs;     /* Max number of MBs per splash; overrides i_slice_count. */
    int i_slice_min_mbs;     /* Min number of MBs per splash */
    int i_slice_count;       /* Number of slices per frame: forces rectangular slices. */
    int i_slice_count_max;   /* Absolute cap on slices per frame; stops applying splash-max-size
                              * and splash-max-mbs if this is reached. */
     ...
     *
     * It is generally sensible to combine this callback with a use of splash-max-mbs or
     * splash-max-size.
     *
