...
import com.reelvideos.app.databinding.FragmentFollowingBinding;
...
import static com.reelvideos.app.config.Constants.API_GET_FOLLOWING;
...
public class FollowingFragment extends BaseFragment {
    ...
    String userID;
    NewFollowingBroadCast mReceiver;
    ...
    private class NewFollowingBroadCast extends BroadcastReceiver {
    ...
    public void initComponents() {
        ...
        mReceiver = new NewFollowingBroadCast();
        activity.registerReceiver(mReceiver, new IntentFilter("newFollowing"));
    ...
    private void loadUpFromAPI() {
        ...
        handler.post(() -> callNonAuthAPI(API_GET_FOLLOWING.replace("%id%", userID), 0, new ApiResponseCallback() {
            @Override
