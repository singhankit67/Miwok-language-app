...
import com.reelvideos.app.recorder.EditorActivity
import com.reelvideos.app.R
import com.reelvideos.app.recorder.adapter.EffectAdapter
import com.reelvideos.app.recorder.entity.Effect
import com.reelvideos.app.recorder.fragment.EffectFilterFragment
...
//    private val mContent = arrayOf("dream.json", "effect_filter.json", "split_screen.json", "transition.json")
        private val mPageTitle = arrayOf(R.string.dynamic)
        private val mContent = arrayOf("effect_filter.json")
